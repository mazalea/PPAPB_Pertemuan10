...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapterPahlawan = PahlawanAdapter(generateDummy()){ disaster ->
            Toast.makeText(this@MainActivity,"Pahlawan ${disaster.namePahlawan}", Toast.LENGTH_SHORT).show()
        }
        with(binding){
            rvPahlawan.apply {
    ...
    private fun generateDummy(): List<Pahlawan> {
        ...
        return listOf(
            Pahlawan(R.drawable.soedirman, "Jenderal Soedirman", deskripsiSoedirman),
            Pahlawan(R.drawable.nyi_ageng_serang, "Nyi Ageng Serang", deskripsiNyiAgengSerang),
            Pahlawan(R.drawable.herman_johannes, "Herman Johannes", deskripsiHermanJohannes),
            Pahlawan(R.drawable.pierre_tendean, "Pierre Tendean", deskripsiPierreTendean),
            Pahlawan(R.drawable.sultan_agung, "Sultan Agung", deskripsiSultanAgung)
        )
    }
}